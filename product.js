...
const app = express();
const uri = "mongodb+srv://thanhhien:Hien123@@cluster0.qvrok.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
product_router.get('/delete', async function (req, res) {
    ...
    const avatar = req.query.img;
    const o_id = new mongo.ObjectID(id);
    const condition = {
        '_id': o_id
    };
    const is_remove = await collection.removeOne(condition);
    const dir = __dirname + '/public/uploads/' + avatar;
